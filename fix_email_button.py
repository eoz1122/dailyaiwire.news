...
def update_email_template():
    print("--- Updating Welcome Email Template (Forcing White Text) ---")
...
<head>
    ...
    <style>
        ...
        /* Force color with !important to override Gmail/Apple Mail default link blue */
        .btn { display: inline-block; background-color: #2563eb; color: #ffffff !important; padding: 12px 24px; border-radius: 12px; text-decoration: none; font-weight: 700; font-size: 14px; -webkit-text-fill-color: #ffffff; }
    </style>
</head>
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <!-- Inline style backup for extra safety -->
            <a href="https://dailyaiwire.news" class="btn" style="color: #ffffff !important; text-decoration: none;">Access the Lab</a>
        </div>
    </div>
</body>
</html>""")
...
if __name__ == "__main__":
    ...
    # No restart needed for template changes in Flask usually if strictly template rendering, 
    # but supervisors might cache. Restart creates no harm and flushes buffers.
    print("--- Restarting Service ---")
    run("sudo supervisorctl restart dailyaiwire")
    print("DONE! Email Button Fixed.")
